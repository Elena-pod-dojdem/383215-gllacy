...
* Студент: [Елена Евстафьева](https://up.htmlacademy.ru/htmlcss/18/user/383215).
* Наставник: `Я хочу пройти курс повторно без наставника`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/383215-gllacy) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
